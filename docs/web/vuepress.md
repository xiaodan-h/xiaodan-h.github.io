...
VuePress 由两部分组成：第一部分是一个 [极简静态网站生成器](https://github.com/vuejs/vuepress/tree/master/packages/%40vuepress/core)，w它包含由 Vue 驱动的[主题系统](../theme/README.md) and [插件API](../plugin/README.md), 另一个部分是为书写技术文档而优化的[d默认主题(../theme/default-theme-config.md)，它的诞生初衷是为了支持 Vue 及其子项目的文档需求。
